...
parser.add_argument('--root_path', type=str, default='./data/LA/2018LA_Seg_Training_Set/', help='Name of Experiment')
parser.add_argument('--model', type=str,  default='SPSS', help='model_name')
parser.add_argument('--dataset', type=str,  default='la', help='dataset to use')
parser.add_argument('--gpu', type=str,  default='0', help='GPU to use')
parser.add_argument('--iteration', type=int,  default=6000, help='iteration')
